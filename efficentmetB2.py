...
callbacks = [
    ...
    ModelCheckpoint("best_model_1.h5", save_best_only=True)
]
...
# model.save("xray_efficentnet_model")  
...
model.save("xray_efficent_model.keras")